          ...
          <div className="max-w-6xl mx-auto space-y-20 md:space-y-24">
            ...
            <div className="backdrop-blur-md rounded-3xl shadow-xl border-2 border-white/40 animate-fade-in-up delay-400 relative overflow-hidden">
              ...
              <div className="relative z-10 p-10 md:p-16">
                <h2 className="text-4xl md:text-5xl font-bold text-center mb-14 text-gray-900">Why Guide with WanderNest?</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl p-8 shadow-soft hover:shadow-premium hover-lift-lg group border-2 border-ui-blue-primary/60 hover:border-ui-blue-accent/60 transition-all duration-300">
                    <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-ui-blue-primary to-ui-blue-secondary text-white mb-5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
                      <DollarSign className="w-7 h-7" />
                    </div>
                    <h3 className="font-bold text-xl mb-3 text-gray-900 group-hover:text-ui-blue-accent transition-colors">Earn More</h3>
                    <p className="text-base text-gray-700 leading-relaxed font-medium">
                      Make significantly more than standard campus jobs with flexible hours
                    </p>
                  </div>

                  <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl p-8 shadow-soft hover:shadow-premium hover-lift-lg group border-2 border-ui-purple-primary/60 hover:border-ui-purple-accent/60 transition-all duration-300">
                    <div className="inline-flex p-4 rounded-xl gradient-vibrant text-white mb-5 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-300 shadow-glow-purple">
                      <Clock className="w-7 h-7" />
                    </div>
                    <h3 className="font-bold text-xl mb-3 text-gray-900 group-hover:text-ui-purple-accent transition-colors">Fully Flexible</h3>
                    <p className="text-base text-gray-700 leading-relaxed font-medium">
                      Choose your own time slots and work around your class schedule
                    </p>
                  </div>

                  <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-2xl p-8 shadow-soft hover:shadow-premium hover-lift-lg group border-2 border-ui-success/60 hover:border-ui-success/60 transition-all duration-300 md:col-span-2 lg:col-span-1">
                    <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-ui-success to-ui-success text-white mb-5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
                      <Users className="w-7 h-7" />
                    </div>
                    <h3 className="font-bold text-xl mb-3 text-gray-900 group-hover:text-ui-success transition-colors">Cultural Connection</h3>
                    <p className="text-base text-gray-700 leading-relaxed font-medium">
