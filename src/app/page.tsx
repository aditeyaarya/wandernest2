      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 container mx-auto px-4 py-16 flex flex-col items-center justify-center">
          <div className="max-w-5xl mx-auto text-center space-y-16">
            <section aria-labelledby="hero-heading" className="space-y-6 animate-slide-up-fade">
              <h1 id="hero-heading" className="text-5xl md:text-7xl font-serif font-bold leading-tight tracking-tight text-white text-shadow-lg">
              ...
              <p className="text-xl md:text-2xl text-white max-w-3xl mx-auto leading-relaxed font-sans text-shadow">
            ...
            <section aria-label="Get Started" className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <Link href="/tourist" className="block" aria-label="Explore tourist options">
                <article className="group cursor-pointer rounded-2xl shadow-xl hover:shadow-elevated transition-all duration-500 relative overflow-hidden h-[220px] hover:scale-105 hover:-translate-y-2 focus-visible:outline-3 focus-visible:outline-ui-blue-accent focus-visible:outline-offset-4">
                  <div className="absolute inset-0">
                    <Image
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-end p-6">
                    <div className="space-y-2">
                      <div className="inline-flex p-2 rounded-xl bg-ui-blue-primary/90 backdrop-blur-sm text-white shadow-lg group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
                    ...
                    <div className="mt-4 space-y-2 max-h-0 opacity-0 group-hover:max-h-32 group-hover:opacity-100 overflow-hidden transition-all duration-500 ease-in-out">
              ...
              <Link href="/student" className="block" aria-label="Explore student guide opportunities">
                <article className="group cursor-pointer rounded-2xl shadow-xl hover:shadow-elevated transition-all duration-500 relative overflow-hidden h-[220px] hover:scale-105 hover:-translate-y-2 focus-visible:outline-3 focus-visible:outline-ui-purple-accent focus-visible:outline-offset-4">
                  <div className="absolute inset-0">
                    <Image
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-end p-6">
                    <div className="space-y-2">
                      <div className="inline-flex p-2 rounded-xl bg-ui-purple-primary/90 backdrop-blur-sm text-white shadow-lg group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
